...
void Display_readings(float X,float Y,float Z,float gX,float gY,float gZ,float secs){
  ...
  StickCP2.Display.printf("%+6.2f  ",X );
  StickCP2.Display.setCursor(140,30);
  StickCP2.Display.printf("%+6.2f  ",gX);
  
  StickCP2.Display.setCursor(40,50);
  StickCP2.Display.printf("%+6.2f  ",Y );
  StickCP2.Display.setCursor(140,50);
  StickCP2.Display.printf("%+6.2f  ",gY);
  StickCP2.Display.setCursor(40,70);
  StickCP2.Display.printf("%+6.2f  ",Z );
  StickCP2.Display.setCursor(140,70);
  StickCP2.Display.printf("%+6.2f  ",gZ);
  StickCP2.Display.setCursor(70,90);
  StickCP2.Display.printf("%6.3f",secs);
}
...
void on_A_pressedFor(){
    ...
    StickCP2.Display.printf("Restarting");
    // lets restart device
...
void setup() {
 ...
 // M5.begin();
  ...
  //StickCP2.Display.println("IMU Readings");
  StickCP2.Display.println("IMU: Accel  Gyro");
  StickCP2.Display.setCursor(15,30);
  StickCP2.Display.println("X");
  StickCP2.Display.setCursor(15,50);
  StickCP2.Display.println("Y");
  StickCP2.Display.setCursor(15,70);
  StickCP2.Display.println("Z");
  StickCP2.Display.setCursor(15,90);
  StickCP2.Display.println("Secs");
  StickCP2.Display.setTextSize(1);
...
void loop() {
  ...
  if (start_read) {
    ...
    acc_buff[idx+1]=data.accel.x;
    acc_buff[idx+2]=data.accel.y;
    acc_buff[idx+3]=data.accel.z;
    acc_buff[idx+4]=data.gyro.x;
    acc_buff[idx+5]=data.gyro.y;
    acc_buff[idx+6]=data.gyro.z;
