...
class WatchBLECharacteristicCallbacks : public BLECharacteristicCallbacks
{
public:
  ...
  void onWrite(BLECharacteristic *pCharacteristic)
  {
    ...
    std::string cmd;
    std::string argstr;
    ExerBLE::GetInstance()->setConnectedDeviceName("WATCH BLE UUID");
  }
};
...
public:
  ...
  void onWrite(BLECharacteristic *pCharacteristic)
  {
    ...
    if (cmd == "n" || cmd == "N")
    {
      ...
      sprintf(device_name, "Name_%s", argstr);
      ExerBLE::GetInstance()->setConnectedDeviceName(device_name);
    }
